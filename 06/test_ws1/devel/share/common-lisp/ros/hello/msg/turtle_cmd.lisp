...
(cl:defmethod cl:initialize-instance :after ((m <turtle_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'turtle_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hello-msg:<turtle_cmd> is deprecated: use hello-msg:turtle_cmd instead.")))
...
(cl:defmethod theta-val ((m <turtle_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello-msg:theta-val is deprecated.  Use hello-msg:theta instead.")
  (theta m))

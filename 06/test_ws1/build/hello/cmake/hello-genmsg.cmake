...
set(MSG_I_FLAGS "-Ihello:/home/luca/test_ws1/src/hello/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/luca/test_ws1/src/hello/srv/service.srv" NAME_WE)
add_custom_target(_hello_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello" "/home/luca/test_ws1/src/hello/srv/service.srv" ""
)

get_filename_component(_filename "/home/luca/test_ws1/src/hello/msg/turtle_cmd.msg" NAME_WE)
add_custom_target(_hello_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello" "/home/luca/test_ws1/src/hello/msg/turtle_cmd.msg" ""
)
...
_generate_msg_cpp(hello
  "/home/luca/test_ws1/src/hello/msg/turtle_cmd.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(hello
  "/home/luca/test_ws1/src/hello/srv/service.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/hello
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello\")")
  # install generated code
  install(
